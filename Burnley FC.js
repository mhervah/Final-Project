var request = new Request('http://api.football-data.org/v1/teams/328/players', {
	method: 'GET', 
	mode: 'cors', 
	redirect: 'follow',
	headers: new Headers({
...
var request2 = new Request('http://api.football-data.org/v1/teams/328/fixtures', {
	method: 'GET', 
	mode: 'cors', 
	redirect: 'follow',
	headers: new Headers({
...
logo.src="Team Logos/burnley.png";
logo.setAttribute("style","margin-top:20");
var textnode=document.createTextNode("Burnley FC");
...
.then(function(data) {
	...
	fetch(request3)
			...
			.then(function(data) {
				...
				for(let i=0;i<20;i++)
					if(data["standing"][i]["teamName"]==="Burnley FC"){
	...
	.then(function(data) {
		...
		for(var j=0;j<38;j++)
		{
						...
						if(data["fixtures"][j]["homeTeamName"]==="Burnley FC")
						...
						matchday.appendChild(document.createTextNode("GW "+(j+1)));
			...
			var coachName=document.createTextNode("Manager: Sean Dyche");
			var coachImg=document.createElement("img");
			coachImg.src="Coaches/burnley.jpg";
			...
			var stadiumName=document.createTextNode("Stadium: Turf Moor");
			var stadImg=document.createElement("img");
			stadImg.src="Stadiums/burnley.jpg";
