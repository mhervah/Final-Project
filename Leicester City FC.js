var request = new Request('http://api.football-data.org/v1/teams/338/players', {
	method: 'GET', 
	mode: 'cors', 
	redirect: 'follow',
	headers: new Headers({
...
var request2 = new Request('http://api.football-data.org/v1/teams/338/fixtures', {
	method: 'GET', 
	mode: 'cors', 
	redirect: 'follow',
	headers: new Headers({
...
logo.src="Team Logos/leicester-city.png";
logo.setAttribute("style","margin-top:20");
logo.width=200;
var textnode=document.createTextNode("Leicester City FC");
...
.then(function(data) {
	...
	fetch(request3)
			...
			.then(function(data) {
				...
				for(let i=0;i<20;i++)
					if(data["standing"][i]["teamName"]==="Leicester City FC"){
	...
	.then(function(data) {
		var matchTab=document.createElement("table");
					...
					while(data["fixtures"][j]!==undefined){
						...
						if(data["fixtures"][j]["homeTeamName"]==="Leicester City FC")
			...
			var coachName=document.createTextNode("Manager: Claude Puel");
			var coachImg=document.createElement("img");
			coachImg.src="Coaches/leicester-city.jpg";
			...
			var stadiumName=document.createTextNode("Stadium: King Power");
			var stadImg=document.createElement("img");
			stadImg.src="Stadiums/leicester-city.jpg";
