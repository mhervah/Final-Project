var request = new Request('http://api.football-data.org/v1/teams/397/players', {
	method: 'GET', 
	mode: 'cors', 
	redirect: 'follow',
	headers: new Headers({
...
var request2 = new Request('http://api.football-data.org/v1/teams/397/fixtures', {
	method: 'GET', 
	mode: 'cors', 
	redirect: 'follow',
	headers: new Headers({
...
logo.src="Team Logos/brighton.png";
logo.setAttribute("style","margin-top:20");
logo.width=200;
var textnode=document.createTextNode("Brighton & Hove Albion");
...
.then(function(data) {
	...
	fetch(request3)
			...
			.then(function(data) {
				...
				for(let i=0;i<20;i++)
					if(data["standing"][i]["teamName"]==="Brighton & Hove Albion"){
	...
	.then(function(data) {
		var matchTab=document.createElement("table");
					...
					while(data["fixtures"][j]!==undefined){
						...
						if(data["fixtures"][j]["homeTeamName"]==="Brighton & Hove Albion")
			...
			var coachName=document.createTextNode("Manager: Chris Hughton");
			var coachImg=document.createElement("img");
			coachImg.src="Coaches/brighton.jpg";
			...
			var stadiumName=document.createTextNode("Stadium: The Amex");
			var stadImg=document.createElement("img");
			stadImg.src="Stadiums/brighton.jpg";
