var request = new Request('http://api.football-data.org/v1/teams/1044/players', {
	method: 'GET', 
	mode: 'cors', 
	redirect: 'follow',
	headers: new Headers({
...
var request2 = new Request('http://api.football-data.org/v1/teams/1044/fixtures', {
	method: 'GET', 
	mode: 'cors', 
	redirect: 'follow',
	headers: new Headers({
...
logo.src="Team Logos/bournemouth.png";
logo.setAttribute("style","margin-top:20");
logo.width=200;
var textnode=document.createTextNode("AFC Bournemouth");
...
.then(function(data) {
	...
	fetch(request3)
			...
			.then(function(data) {
				...
				for(let i=0;i<20;i++)
					if(data["standing"][i]["teamName"]==="AFC Bournemouth"){
	...
	.then(function(data) {
		var matchTab=document.createElement("table");
					...
					while(data["fixtures"][j]!==undefined){
						...
						if(data["fixtures"][j]["homeTeamName"]==="AFC Bournemouth")
			...
			var coachName=document.createTextNode("Manager: Eddie Howe");
			var coachImg=document.createElement("img");
			coachImg.src="Coaches/bournemouth.jpg";
			...
			var stadiumName=document.createTextNode("Stadium: Vitality Stadium");
			var stadImg=document.createElement("img");
			stadImg.src="Stadiums/bournemouth.jpg";
